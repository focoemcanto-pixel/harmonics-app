...
export async function POST(request) {
  ...
  try {
    ...
    console.info('[SCALES_DELETE_MANY][DELETE_BULK][PAYLOAD]', { requestedCount: eventIds.length });
    ...
    console.info('[SCALES_DELETE_MANY][DELETE_BULK][RESULT]', {
    ...
    console.error('[SCALES_DELETE_MANY][DELETE_BULK][ERROR]', {
