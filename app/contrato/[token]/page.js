    ...
    const contractPayload = {
      ...
      raw_payload: {
        ...
        onboarding_fake_event: {
          ...
          location: clientForm?.event_location_name || precontract?.location_name || 'Espaço Harmonics Demo',
          location_name: clientForm?.event_location_name || precontract?.location_name || 'Espaço Harmonics Demo',
          address: clientForm?.event_location_address || precontract?.location_address || null,
          location_address: clientForm?.event_location_address || precontract?.location_address || null,
          city: clientForm?.address_city || precontract?.city || null,
          state: clientForm?.address_state || precontract?.state || null,
          formation: precontract?.formation || 'Quarteto',
          instruments: precontract?.instruments || 'Voz, Violino, Piano e Cello',
        },
