    ...
    <div className="space-y-6">
      ...
      <section className="rounded-[28px] border border-[#dbe3ef] bg-white p-6 shadow-[0_10px_26px_rgba(17,24,39,0.04)]">
        ...
        <p className="mt-2 max-w-3xl text-[15px] leading-7 text-[#64748b]">
          Histórico completo de disparos automáticos, rastreamento de falhas, análise de performance e auditoria de envios.
        </p>
      </section>
      ...
      <section className="rounded-[28px] border border-[#dbe3ef] bg-white p-12 text-center shadow-[0_10px_26px_rgba(17,24,39,0.04)]">
        <div className="mx-auto max-w-md">
          ...
          <p className="mt-2 text-[14px] leading-6 text-[#64748b]">
            Visualize o histórico completo de mensagens automáticas enviadas, status de entrega, erros e métricas de performance.
          </p>
          ...
          <div className="mt-8 space-y-2 text-left">
            <div className="rounded-xl border border-[#e2e8f0] bg-[#f8fafc] p-4">
              ...
              <ul className="mt-2 space-y-1 text-[13px] text-[#64748b]">
                <li>• Timeline de disparos automáticos</li>
                <li>• Filtros por status, data e destinatário</li>
                <li>• Detalhamento de erros e retentativas</li>
