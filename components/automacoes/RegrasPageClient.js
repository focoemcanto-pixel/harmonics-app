...
const EVENT_TYPES = [
  ...
  { value: 'contract_signed_admin', label: 'Admin — contrato assinado' },
  { value: 'contract_review_released_client', label: 'Revisão de contrato liberada (cliente)' },
  ...
  { value: 'repertoire_review_released_client', label: 'Revisão de repertório liberada (cliente)' },
  ...
  { value: 'event_day_confirmation_client', label: 'Confirmação no dia do evento (cliente)' },
...
const QUICK_SECTIONS = [
  ...
  },
  {
    ...
    presets: [
      ...
      {
        id: 'contract_signed_admin',
        key: 'admin_contrato_assinado_rapido',
        name: 'Admin — contrato assinado',
        title: 'Admin — contrato assinado',
        subtitle: 'Notifica admin quando contrato é assinado',
        event_type: 'contract_signed_admin',
        recipient_type: 'admin',
        triggerType: 'instant',
        badge: 'Instantâneo',
      },
      {
        id: 'contract_review_released_client',
        key: 'contrato_revisao_liberada_rapido',
        name: 'Revisão de contrato liberada',
        title: 'Revisão de contrato liberada',
        subtitle: 'Avisa cliente quando a revisão do contrato for concluída',
  ...
  },
  {
    ...
    presets: [
      ...
      {
        id: 'repertoire_review_released_client',
        key: 'repertorio_revisao_liberada_rapido',
        name: 'Revisão de repertório liberada',
        title: 'Revisão de repertório liberada',
        subtitle: 'Avisa cliente quando a edição do repertório for reaberta',
  ...
  },
  {
    ...
    presets: [
      ...
      {
        id: 'event_day_confirmation_client',
        key: 'confirmacao_dia_evento_rapido',
        name: 'Confirmação no dia do evento',
        title: 'Confirmação no dia do evento',
        subtitle: 'Confirma horário no timing automático e comercial',
                        ...
                        <>
                          ...
                          <div className="mt-4 flex flex-wrap gap-2">
                            ...
                            <button
                              ...
                              className="rounded-full border border-sky-300 bg-sky-50 px-3 py-1.5 text-xs font-bold text-sky-700 disabled:opacity-60"
                            >
