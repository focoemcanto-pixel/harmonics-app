...
const MOBILE_DRAWER_SECTIONS = [
  ...
  { key: 'comercial', label: 'COMERCIAL', items: [{ module: 'contratos', label: 'Orçamentos', href: '/orcamentos', icon: '◈', helper: 'Preço e logística' }, { module: 'contratos', label: 'Contratos', href: '/contratos', icon: '📝', helper: 'Fluxo contratual' }, { module: 'contratos', label: 'Pré-contratos', href: '/pre-contratos', icon: '🔗', helper: 'Comercial inicial' }, { module: 'contratos', label: 'Templates de contrato', href: '/contratos/templates', icon: '📄', helper: 'Modelos oficiais' }, { module: 'pagamentos', label: 'Pagamentos', href: '/pagamentos', icon: '💳', helper: 'Receitas e custos' }] },
