        ...
        {ITEMS.map((item) => {
          ...
          return (
            <button
              ...
              className={`relative flex min-h-[70px] flex-col items-center justify-center rounded-[18px] px-2 py-2 text-center transition-all duration-200 ${
                isActive
            ...
            >
              ...
              <span
                className={`mt-1 text-[10px] font-black leading-4 ${
