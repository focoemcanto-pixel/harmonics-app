          ...
          <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-5 pb-[calc(env(safe-area-inset-bottom,0px)+20px)] pt-5 [-webkit-overflow-scrolling:touch] lg:hidden">
            <div className="flex min-w-0 flex-col gap-5">
              ...
              <div className="rounded-[26px] border border-white/10 bg-[linear-gradient(180deg,rgba(124,58,237,0.16),rgba(255,255,255,0.03))] p-5 shadow-[0_14px_34px_rgba(15,23,42,0.16)]">
                ...
                <div className="mt-3 break-words text-[24px] font-black tracking-[-0.04em] text-white">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  type="button"
                  onClick={onPrev}
                  className={`${CONTROL_BUTTON_CLASS} border border-white/10 bg-white/10`}
                >
                  Anterior
                </button>
                ...
                <button
                  ...
                  className={`${CONTROL_BUTTON_CLASS} bg-gradient-to-r from-violet-500 to-fuchsia-500 disabled:cursor-not-allowed disabled:opacity-50`}
                >
                  YouTube
                </button>
                    ...
                    playlist.map((track, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`${TRACK_BUTTON_BASE_CLASS} ${
                            active
                        ...
                        >
                          <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="break-words text-[15px] font-black text-white">{track.title}</div>

                              {track.subtitle ? (
                                <div className="mt-1 break-words text-[12px] font-semibold uppercase tracking-[0.08em] text-white/60">
                                  {track.subtitle}
                                </div>
                              ) : null}

                              {track.notes ? (
                                <div className="mt-2 break-words text-[12px] leading-5 text-white/50">{track.notes}</div>
                              ) : null}
                            </div>
                          </div>
                        </button>
