const DATE_FORMATTER_BR = new Intl.DateTimeFormat('pt-BR', {
  day: '2-digit',
  month: '2-digit',
  year: 'numeric',
});

const LONG_DATE_FORMATTER_BR = new Intl.DateTimeFormat('pt-BR', {
  day: 'numeric',
  month: 'long',
  year: 'numeric',
});
...
export function formatDateBR(value) {
  ...
  return DATE_FORMATTER_BR.format(d);
}
...
export function formatLongDateBR(value) {
  ...
  return LONG_DATE_FORMATTER_BR.format(d);
}
