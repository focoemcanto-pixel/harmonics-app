export function isRepertorioTravado(status) {
...
export function getRepertorioUiState({ status, eventDate, liberadoParaEdicao }) {
  const s = String(status || '').trim().toUpperCase();
...
export function getRepertorioProgress({ status, etapasPreenchidas, totalEtapas }) {
