...
function buildPrompt({ text, missingFields }) {
  return `Extraia dados APENAS da cláusula/objeto do evento no contrato abaixo e retorne SOMENTE JSON válido no formato solicitado.\n\nFormato obrigatório:\n{\n  "client_name": "",\n  "event_type": "",\n  "event_date": "YYYY-MM-DD",\n  "event_time": "HH:mm",\n  "location_name": "",\n  "location_address": "",\n  "formation": "",\n  "instruments": "",\n  "reception_hours": 0,\n  "has_sound": false,\n  "agreed_amount": 0,\n  "observations": ""\n}\n\nRegras:\n- Extrair dados apenas do objeto/cláusula do evento\n- Ignorar endereço do CONTRATANTE\n- Ignorar endereço do CONTRATADO\n- Instrumentos devem ser extraídos da cláusula do objeto e normalizados assim:\n  pianista => Piano\n  teclado/tecladista => Teclado\n  violinista => Violino\n  violonista => Violão\n  vocalista/cantor/voz => Voz\n- Retorne instruments em string amigável. Exemplo: \"Voz, teclado e violino\"\n- Inferir formation com base na contagem total de integrantes:\n  1=Solo, 2=Duo, 3=Trio, 4=Quarteto, 5=Quinteto\n- Se houver texto como \"composta por dois instrumentistas (...) e um vocalista\", contar corretamente os integrantes.\n- Se não tiver certeza, deixar vazio\n- Retornar somente JSON válido\n\nCampos faltantes prioritários: ${missingFields.join(', ') || 'nenhum'}\n\nContrato:\n${text}`;
}
