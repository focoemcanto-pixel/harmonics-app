...
function getGoogleAuth() {
  ...
  console.log('[googleContractGenerator] typeof google:', typeof google);
  console.log('[googleContractGenerator] typeof refreshToken:', typeof refreshToken);
  console.log('[googleContractGenerator] refreshToken len:', refreshToken.length);
  console.log('[googleContractGenerator] refreshToken prefix:', refreshToken.slice(0, 12));
