...
const PLACEHOLDER_ALIASES = {
  client_name: ['NOME', 'CLIENTE_NOME', 'nome', 'cliente_nome', 'contratante_nome'],
  nome: ['NOME', 'CLIENTE_NOME', 'client_name', 'cliente_nome', 'contratante_nome'],
  cliente_nome: ['NOME', 'CLIENTE_NOME', 'client_name', 'nome', 'contratante_nome'],
  contratante_nome: ['NOME', 'CLIENTE_NOME', 'client_name', 'nome', 'cliente_nome'],
  client_marital_status: ['ESTADO_CIVIL', 'estado_civil', 'contratante_estado_civil'],
  estado_civil: ['ESTADO_CIVIL', 'client_marital_status', 'contratante_estado_civil'],
  client_profession: ['PROFISSAO', 'profissao', 'profissão', 'contratante_profissao'],
  profissao: ['PROFISSAO', 'client_profession', 'contratante_profissao'],
  client_cpf: ['CPF', 'cpf', 'contratante_cpf'],
  cpf: ['CPF', 'client_cpf', 'contratante_cpf'],
  client_rg: ['RG', 'rg', 'contratante_rg'],
  rg: ['RG', 'client_rg', 'contratante_rg'],
  client_address: ['ENDERECO', 'endereco', 'endereço', 'contratante_endereco'],
  endereco: ['ENDERECO', 'client_address', 'contratante_endereco'],
