export const ONBOARDING_FLOW_STEPS = [
  ...
  { key: 'client_panel', title: 'Painel do cliente', href: '/dashboard', flag: 'hasSignedContract' },
  { key: 'client_repertoire', title: 'Repertório do cliente', href: '/dashboard', flag: 'hasClientRepertoireSubmitted' },
  ...
  { key: 'formation_template', title: 'Template de formação', href: '/escalas/templates?guide=formation-template', flag: 'hasFormationTemplate' },
  { key: 'scale_with_formation', title: 'Escala do evento demo', href: '/eventos?tab=escala&guide=scale-with-formation', flag: 'hasScale' },
  { key: 'member_panel', title: 'Painel do membro', href: '/membro?guide=member-panel-demo', flag: 'memberPanelTourCompleted' },
  { key: 'automation_overview', title: 'Automações', href: '/automacoes?guide=automation-overview', flag: 'hasAutomationsViewed' },
...
export const ONBOARDING_GUIDE_TO_STEP = {
  ...
  scale: 'scale_with_formation',
  'scale-builder': 'scale_with_formation',
  'scale-with-formation': 'scale_with_formation',
  'member-panel': 'member_panel',
  'member-panel-demo': 'member_panel',
  automations: 'automation_overview',
  'automation-overview': 'automation_overview',
  finance: 'finance',
...
export function appendDemoEventId(href, demoEventId) {
  ...
  if (path === '/eventos' && (params.get('guide') === 'scale' || params.get('guide') === 'scale-with-formation')) return `/eventos/${demoEventId}?${params.toString()}`;
...
export function buildOnboardingFlowStatus(facts = {}) {
  ...
  return {
    ...
    completed: current.key === 'complete',
  };
}
