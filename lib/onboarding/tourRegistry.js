export const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    description: 'Monte o texto base do contrato com um guia visual passo a passo, aprenda as tags dinâmicas e salve um modelo reutilizável.',
  ...
  },
  {
    ...
    href: '/eventos?guide=event&onboarding=resume',
    cta: 'Criar evento',
    stage: 'operations',
    order: 6,
  },
...
export const TOUR_REGISTRY = {
  contract_event_flow: {
    ...
    description: 'Fluxo guiado para configurar workspace, criar template com tags dinâmicas, tipos de evento, pré-contrato, simulação do cliente e só então operação do evento.',
    steps: [
      { title: 'Workspace', href: '/settings/workspace', selector: '[data-tour="workspace-settings"]' },
      { title: 'Criar template de contrato', href: '/contratos/templates?guide=template', selector: '[data-tour="contract-template-create"]' },
      { title: 'Tipos de evento', href: '/eventos/tipos?guide=event-types', selector: '[data-tour="event-type-create"]' },
      { title: 'Associar template ao tipo', href: '/eventos/tipos?guide=event-types', selector: '[data-tour="event-type-template-link"]' },
      { title: 'Pré-contrato', href: '/pre-contratos?guide=precontract', selector: '[data-tour="precontract-form"]' },
      { title: 'Link externo / simulação do cliente', href: '/pre-contratos?guide=precontract', selector: '[data-tour="contract-public-link"]' },
      { title: 'Painel cliente', href: '/repertorios', selector: '[data-tour="client-panel-preview"]' },
      { title: 'Evento operacional', href: '/eventos?guide=event&onboarding=resume', selector: '[data-tour="event-operation"]' },
    ],
  },
  external_contract_flow: {
    ...
    steps: [
      { title: 'Preço', href: '/eventos?guide=event&onboarding=resume', selector: '[data-tour="pricing-panel"]' },
      { title: 'Operação', href: '/eventos?guide=event&onboarding=resume', selector: '[data-tour="event-operation"]' },
      { title: 'Salvar evento', href: '/eventos?guide=event&onboarding=resume', selector: '[data-tour="event-save"]' },
    ],
  },
};
