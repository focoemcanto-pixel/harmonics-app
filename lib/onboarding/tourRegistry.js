...
export const TOUR_REGISTRY = {
  contract_event_flow: {
    ...
    steps: [
      ...
      { title: 'Template', href: '/contratos/templates?guide=template', selector: '[data-tour="contract-template-create"]' },
      { title: 'Tags dinâmicas', href: '/contratos/templates?guide=template', selector: '[data-tour="contract-template-tags"]' },
      { title: 'Tipos de evento', href: '/eventos/tipos?guide=event-types', selector: '[data-tour="event-type-create"]' },
      { title: 'Template por tipo', href: '/eventos/tipos?guide=event-types', selector: '[data-tour="event-type-template-link"]' },
      { title: 'Pré-contrato', href: '/pre-contratos?guide=precontract', selector: '[data-tour="precontract-form"]' },
      { title: 'Prévia', href: '/pre-contratos?guide=precontract', selector: '[data-tour="precontract-preview"]' },
      { title: 'Link externo', href: '/pre-contratos?guide=precontract', selector: '[data-tour="contract-public-link"]' },
