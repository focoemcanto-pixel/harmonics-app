// Catálogo do painel do cliente (comportamento legado funcional):
// - admin: curadoria oficial;
// - null: registros antigos que já apareciam na aba Sugestões.
// Não inclui source_type=client/imported para evitar misturar repertório.
const CLIENT_SUGGESTIONS_SOURCE_FILTER =
  'source_type.eq.admin,source_type.is.null';
