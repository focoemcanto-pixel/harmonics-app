...
export async function sendWhatsAppMessage({ to, message, channel: channelOverride = null }) {
  ...
  console.info('[sendWhatsAppMessage][debug] endpoint_final', {
    endpoint,
    provider,
    channelSource,
  });
  console.info('[sendWhatsAppMessage][debug] payload', {
    to,
  ...
  console.info('[sendWhatsAppMessage][debug] provider_status', {
